    ...
    <div class="da-panel">
        ...
        <div id="da-ex-tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
            ...
            <div style="padding-bottom: 20px;">
                ...
                <h4 class="widgettitle">Nội dung khóa học</h4>
                ...
                <div class="par control-group">
                    <label class="control-label required">Thời gian khóa học<span class="required">*</span> </label>
                ...
                <div class="par control-group">
                    ...
                    <div class="controls">
                        <?php echo $form->dropDownList($model,'status', Course::model()->getStatusData()); ?>
...
<script>
    $(function(){
        $('#Course_time_start').datetimepicker({
        });
        $('#Course_time_end').datetimepicker();
    })
</script>
