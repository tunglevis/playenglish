    ...
    <div class="da-panel">
        ...
        <div id="da-ex-tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
            ...
            <div style="padding-bottom: 20px;">
                ...
                <h4 class="widgettitle">Học Viên</h4>
                <div class="par control-group">
                    <?php echo $form->labelEx($model,'user_name', array('class' => 'control-label')); ?>
                    <div class="controls">
                        <?php echo $form->textField($model,'user_name',array('maxlength'=>255, 'class' => 'input-large')); ?>
                        <?php echo $form->error($model,'user_name', array('class' => 'help-inline error'));?>
                    </div>
                </div>
