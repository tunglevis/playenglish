...
<!--            <h2 class="title"><a href="">Tài liệu </a><span class="line"></span></h2>-->
    ...
    <div class="two-thirds column">
        <div class="feed-course" style="overflow: hidden;border: 1px solid #ececec;">
            <form id="feed-form" method="post" enctype="multipart/form-data" action="<?php echo Yii::app()->createUrl("web/user/feedForm", array('id' => $user->id))?>">
                ...
                <textarea title="What's on your mind?" name="feed-text" placeholder="What's on your mind?" autocomplete="off" style="resize: none;height: 63px;min-height: 63px;border: none;"></textarea>
            ...
            <div id="list-feeds">
                <?php foreach($posts as $key => $value):?>
                    <div class="content-feed-course" style="border: 1px solid #ececec;padding: 10px;margin: 15px 0;background-color: #fff">
                        ...
                        <form onsubmit="return add_comment($(this))" comment-id="<?php echo $value->id?>" method="post" enctype="multipart/form-data" action="<?php echo Yii::app()->createUrl("web/user/commentFeed", array('id' => $value->id))?>">
                            <div>
        ...
        $.ajax({
            ...
            success:function(data){
                if(parseInt(data) != 1 && parseInt(data) != 0){
                    ...
                    that.find(".img_file_comment").hide();
                    var html = '<div class="comment-feed">'+
                        '<img src="<?php echo $this->user->id?>" style="width: 32px;display: inline-block;float: left;padding-right: 5px;">'+
                        '<div style="display: inline-block;width: 90%;line-height: 14px;">'+
                        '<span style="display: inline-block; width: 71%; font-size: 13px !important;"><b style="color: #00aec8;"><?php echo $this->user->name?></b>&nbsp;'+text_comment+'</span>'+
                        '<span style="display: block;clear: both;color: #9197a3;font-size: 11px;">1 hr</span>'+
                        '</div>'+
